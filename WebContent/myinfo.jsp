...
<%
	...
	<table width="1500" height="200" class="type09">
		...
		<Button onclick="location.href='main.jsp?target=myinfo_modify_form&id=<%=login%>'">개인정보 수정</Button>
		<Button onclick="location.href='main.jsp?target=member_Delete'">회원 탈퇴</Button>
	<%
	}catch(Exception e){
		e.printStackTrace();
	}finally{
